...
## Data Stats (as of 2026-09-13)

- **661** ModSharp API types with **7695** members
- **671** CS2/Source2 engine schema classes across **7** categories with **0** network fields
- **29515** Valve engine schema classes (CS2/Dota2/Deadlock) with **96909** fields + **2324** enums (full memory layout from ValveResourceFormat)
