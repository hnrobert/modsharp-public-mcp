...
## Data Stats (as of 2026-08-02)

- **632** ModSharp API types with **7202** members
- **668** CS2/Source2 engine schema classes across **7** categories with **0** network fields
- **29498** Valve engine schema classes (CS2/Dota2/Deadlock) with **96855** fields + **2321** enums (full memory layout from ValveResourceFormat)
